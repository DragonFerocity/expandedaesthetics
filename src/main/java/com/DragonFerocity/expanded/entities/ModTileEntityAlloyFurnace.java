...
public class ModTileEntityAlloyFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
  ...
  {
      fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(ModTileEntityAlloyFurnace.class, new String[] {"Items"}));
  }
  ...
  private boolean canSmelt()
  {
      ...
      {
          ItemStack itemstack = ModAlloyFurnaceRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0), ItemStack.EMPTY);
  ...
  public void smeltItem()
  {
      if (this.canSmelt())
      {
          ...
          ItemStack itemstack1 = ModAlloyFurnaceRecipes.instance().getSmeltingResult(itemstack, ItemStack.EMPTY);
