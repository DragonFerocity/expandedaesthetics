...
//Harvest Level: 0: Wood, 1: Gold/Stone, 2: Iron, 3: Diamond
  public static void initBlocks(RegistryEvent.Register<Block> event) {
    ...
    andesitePolishedStairs = createBlock(new ModStairs(Blocks.STONE, "andesite_polished_stairs", CreativeTabs.BUILDING_BLOCKS, 3.0F, 38F, 1, "pickaxe"), event);
    ibAndesitePolishedStairs = createItemBlock(new ItemBlock(andesitePolishedStairs), andesitePolishedStairs);
    
    andesitePolishedStairsAlt = createBlock(new ModStairs(Blocks.STONE, "andesite_polished_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 30F, 1, "pickaxe"), event);
    ...
    birchLamp = createBlock(new ModLamp(Material.WOOD, "birch_lamp", CreativeTabs.DECORATIONS, 1.2F, 4F, 0, "axe", 14/15F, 1.8D), event);
    ...
    brickStairsAlt = createBlock(new ModStairs(Blocks.STONE, "brick_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 30F, 1, "pickaxe"), event);
    ibBrickStairsAlt = createItemBlock(new ItemBlock(brickStairsAlt), brickStairsAlt);
    
    //Cactus
    cutCactusBlock = createBlock(new ModBlock(Material.WOOD, "cut_cactus_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 2F, 0, "axe"), event);
    ibCutCactusBlock = createItemBlock(new ItemBlock(cutCactusBlock), cutCactusBlock);
    
    cutCactusStairs = createBlock(new ModStairs(Blocks.DIRT, "cut_cactus_stairs", CreativeTabs.BUILDING_BLOCKS, 0.3F, 1.7F, 0, "axe"), event);
    ibCutCactusStairs = createItemBlock(new ItemBlock(cutCactusStairs), cutCactusStairs);
    
    cutCactusStairsAlt = createBlock(new ModStairs(Blocks.DIRT, "cut_cactus_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1.3F, 0, "axe"), event);
    ibCutCactusStairsAlt = createItemBlock(new ItemBlock(cutCactusStairsAlt), cutCactusStairsAlt);
    
    cutCactusLamp = createBlock(new ModLamp(Material.WOOD, "cut_cactus_lamp", CreativeTabs.DECORATIONS, 0.5F, 2.1F, 1, "axe", 14/15F, 1.6D), event);
    ibCutCactusLamp = createItemBlock(new ItemBlock(cutCactusLamp), cutCactusLamp);
    
    cutCactusLantern = createBlock(new ModLantern(Material.WOOD, "cut_cactus_lantern", CreativeTabs.DECORATIONS, 0.25F, 1.5F, 1, "axe", 13/15F, 5, 20, 0.75D), event);
    ...
    cobblestoneChest = createBlock(new ModChest(ModChest.Type.COBBLESTONE, Material.ROCK, "cobblestone_chest", 2.5F, 12.5F, 1, "pickaxe"), event);
    ibCobblestoneChest = createItemBlock(new ItemBlock(cobblestoneChest), cobblestoneChest);
    
    cobblestoneStairsAlt = createBlock(new ModStairs(Blocks.STONE, "cobblestone_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 30F, 1, "pickaxe"), event);
    ibCobblestoneStairsAlt = createItemBlock(new ItemBlock(cobblestoneStairsAlt), cobblestoneStairsAlt);
    
    //Dark Oak
    darkOakLamp = createBlock(new ModLamp(Material.WOOD, "dark_oak_lamp", CreativeTabs.DECORATIONS, 1.2F, 4F, 0, "axe", 14/15F, 1.8D), event);
    ibDarkOakLamp = createItemBlock(new ItemBlock(darkOakLamp), darkOakLamp);
    
    darkOakLantern = createBlock(new ModLantern(Material.WOOD, "dark_oak_lantern", CreativeTabs.DECORATIONS, 1F, 4F, 0, "axe", 13/15F, 5, 20, 0.7D), event);
    ...
    dioritePolishedStairs = createBlock(new ModStairs(Blocks.STONE, "diorite_polished_stairs", CreativeTabs.BUILDING_BLOCKS, 2.5F, 35F, 1, "pickaxe"), event);
    ibDioritePolishedStairs = createItemBlock(new ItemBlock(dioritePolishedStairs), dioritePolishedStairs);
    
    dioritePolishedStairsAlt = createBlock(new ModStairs(Blocks.STONE, "diorite_polished_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2F, 25F, 1, "pickaxe"), event);
    ibDioritePolishedStairsAlt = createItemBlock(new ItemBlock(dioritePolishedStairsAlt), dioritePolishedStairsAlt);
    
    dioritePolishedLantern = createBlock(new ModLantern(Material.ROCK, "diorite_polished_lantern", CreativeTabs.DECORATIONS, 2F, 18F, 1, "pickaxe", 13/15F, 5, 20, 0.6D), event);
    ibDioritePolishedLantern = createItemBlock(new ItemBlock(dioritePolishedLantern), dioritePolishedLantern);
    
    dioritePolishedLamp = createBlock(new ModLamp(Material.ROCK, "diorite_polished_lamp", CreativeTabs.DECORATIONS, 2F, 30F, 1, "pickaxe", 14/15F, 1.9D), event);
    ...
    dioritePolishedChest = createBlock(new ModChest(ModChest.Type.POLISHED_DIORITE, Material.ROCK, "diorite_polished_chest", 4F, 40F, 1, "pickaxe"), event);
    ...
    glassStairs = createBlock(new ModStairs(Blocks.GLASS, "glass_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibGlassStairs = createItemBlock(new ItemBlock(glassStairs), glassStairs);
    
    glassStairsAlt = createBlock(new ModStairs(Blocks.GLASS, "glass_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibGlassStairsAlt = createItemBlock(new ItemBlock(glassStairsAlt), glassStairsAlt);
    
    //White
    whiteGlassStairs = createBlock(new ModStairs(Blocks.GLASS, "glass_white_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibWhiteGlassStairs = createItemBlock(new ItemBlock(whiteGlassStairs), whiteGlassStairs);
    
    whiteGlassStairsAlt = createBlock(new ModStairs(Blocks.GLASS, "glass_white_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibWhiteGlassStairsAlt = createItemBlock(new ItemBlock(whiteGlassStairsAlt), whiteGlassStairsAlt);
    
    //Orange
    orangeGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_orange_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibOrangeGlassStairs = createItemBlock(new ItemBlock(orangeGlassStairs), orangeGlassStairs);
    
    orangeGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_orange_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibOrangeGlassStairsAlt = createItemBlock(new ItemBlock(orangeGlassStairsAlt), orangeGlassStairsAlt);
    
    //Magenta
    magentaGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_magenta_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibMagentaGlassStairs = createItemBlock(new ItemBlock(magentaGlassStairs), magentaGlassStairs);
    
    magentaGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_magenta_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibMagentaGlassStairsAlt = createItemBlock(new ItemBlock(magentaGlassStairsAlt), magentaGlassStairsAlt);
    
    //Light Blue
    lightBlueGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_light_blue_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibLightBlueGlassStairs = createItemBlock(new ItemBlock(lightBlueGlassStairs), lightBlueGlassStairs);
    
    lightBlueGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_light_blue_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibLightBlueGlassStairsAlt = createItemBlock(new ItemBlock(lightBlueGlassStairsAlt), lightBlueGlassStairsAlt);
    
    //Yellow
    yellowGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_yellow_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibYellowGlassStairs = createItemBlock(new ItemBlock(yellowGlassStairs), yellowGlassStairs);
    
    yellowGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_yellow_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibYellowGlassStairsAlt = createItemBlock(new ItemBlock(yellowGlassStairsAlt), yellowGlassStairsAlt);
    
    //Lime
    limeGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_lime_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibLimeGlassStairs = createItemBlock(new ItemBlock(limeGlassStairs), limeGlassStairs);
    
    limeGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_lime_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibLimeGlassStairsAlt = createItemBlock(new ItemBlock(limeGlassStairsAlt), limeGlassStairsAlt);
    
    //Pink
    pinkGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_pink_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibPinkGlassStairs = createItemBlock(new ItemBlock(pinkGlassStairs), pinkGlassStairs);
    
    pinkGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_pink_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibPinkGlassStairsAlt = createItemBlock(new ItemBlock(pinkGlassStairsAlt), pinkGlassStairsAlt);
    
    //Gray
    grayGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_gray_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibGrayGlassStairs = createItemBlock(new ItemBlock(grayGlassStairs), grayGlassStairs);
    
    grayGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_gray_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibGrayGlassStairsAlt = createItemBlock(new ItemBlock(grayGlassStairsAlt), grayGlassStairsAlt);
    
    //Silver
    silverGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_silver_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibSilverGlassStairs = createItemBlock(new ItemBlock(silverGlassStairs), silverGlassStairs);
    
    silverGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_silver_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibSilverGlassStairsAlt = createItemBlock(new ItemBlock(silverGlassStairsAlt), silverGlassStairsAlt);
    
    //Cyan
    cyanGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_cyan_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibCyanGlassStairs = createItemBlock(new ItemBlock(cyanGlassStairs), cyanGlassStairs);
    
    cyanGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_cyan_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibCyanGlassStairsAlt = createItemBlock(new ItemBlock(cyanGlassStairsAlt), cyanGlassStairsAlt);
    
    //Purple
    purpleGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_purple_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibPurpleGlassStairs = createItemBlock(new ItemBlock(purpleGlassStairs), purpleGlassStairs);
    
    purpleGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_purple_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibPurpleGlassStairsAlt = createItemBlock(new ItemBlock(purpleGlassStairsAlt), purpleGlassStairsAlt);
    
    //Blue
    blueGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_blue_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibBlueGlassStairs = createItemBlock(new ItemBlock(blueGlassStairs), blueGlassStairs);
    
    blueGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_blue_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibBlueGlassStairsAlt = createItemBlock(new ItemBlock(blueGlassStairsAlt), blueGlassStairsAlt);
    
    //Brown
    brownGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_brown_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibBrownGlassStairs = createItemBlock(new ItemBlock(brownGlassStairs), brownGlassStairs);
    
    brownGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_brown_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibBrownGlassStairsAlt = createItemBlock(new ItemBlock(brownGlassStairsAlt), brownGlassStairsAlt);
    
    //Green
    greenGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_green_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibGreenGlassStairs = createItemBlock(new ItemBlock(greenGlassStairs), greenGlassStairs);
    
    greenGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_green_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibGreenGlassStairsAlt = createItemBlock(new ItemBlock(greenGlassStairsAlt), greenGlassStairsAlt);
    
    //Red
    redGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_red_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibRedGlassStairs = createItemBlock(new ItemBlock(redGlassStairs), redGlassStairs);
    
    redGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_red_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibRedGlassStairsAlt = createItemBlock(new ItemBlock(redGlassStairsAlt), redGlassStairsAlt);
    
    //Black
    blackGlassStairs = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_black_stairs", CreativeTabs.BUILDING_BLOCKS, 0.6F, 2F, 0, "pickaxe"), event);
    ibBlackGlassStairs = createItemBlock(new ItemBlock(blackGlassStairs), blackGlassStairs);
    
    blackGlassStairsAlt = createBlock(new ModStairs(Blocks.STAINED_GLASS, "glass_black_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 0.2F, 1F, 0, "pickaxe"), event);
    ibBlackGlassStairsAlt = createItemBlock(new ItemBlock(blackGlassStairsAlt), blackGlassStairsAlt);
    
    //Lighted
    blackLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "black_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibBlackLightedGlassBlock = createItemBlock(new ItemBlock(blackLightedGlassBlock), blackLightedGlassBlock);
    
    blueLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "blue_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibBlueLightedGlassBlock = createItemBlock(new ItemBlock(blueLightedGlassBlock), blueLightedGlassBlock);
    
    brownLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "brown_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibBrownLightedGlassBlock = createItemBlock(new ItemBlock(brownLightedGlassBlock), brownLightedGlassBlock);
    
    cyanLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "cyan_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibCyanLightedGlassBlock = createItemBlock(new ItemBlock(cyanLightedGlassBlock), cyanLightedGlassBlock);
    
    grayLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "gray_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibGrayLightedGlassBlock = createItemBlock(new ItemBlock(grayLightedGlassBlock), grayLightedGlassBlock);
    
    greenLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "green_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibGreenLightedGlassBlock = createItemBlock(new ItemBlock(greenLightedGlassBlock), greenLightedGlassBlock);
    
    lightBlueLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "light_blue_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibLightBlueLightedGlassBlock = createItemBlock(new ItemBlock(lightBlueLightedGlassBlock), lightBlueLightedGlassBlock);
    
    limeLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "lime_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibLimeLightedGlassBlock = createItemBlock(new ItemBlock(limeLightedGlassBlock), limeLightedGlassBlock);
    
    magentaLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "magenta_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibMagentaLightedGlassBlock = createItemBlock(new ItemBlock(magentaLightedGlassBlock), magentaLightedGlassBlock);
    
    orangeLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "orange_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibOrangeLightedGlassBlock = createItemBlock(new ItemBlock(orangeLightedGlassBlock), orangeLightedGlassBlock);
    
    pinkLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "pink_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibPinkLightedGlassBlock = createItemBlock(new ItemBlock(pinkLightedGlassBlock), pinkLightedGlassBlock);
    
    purpleLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "purple_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibPurpleLightedGlassBlock = createItemBlock(new ItemBlock(purpleLightedGlassBlock), purpleLightedGlassBlock);
    
    redLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "red_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibRedLightedGlassBlock = createItemBlock(new ItemBlock(redLightedGlassBlock), redLightedGlassBlock);
    
    silverLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "silver_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibSilverLightedGlassBlock = createItemBlock(new ItemBlock(silverLightedGlassBlock), silverLightedGlassBlock);
    
    whiteLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "white_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibWhiteLightedGlassBlock = createItemBlock(new ItemBlock(whiteLightedGlassBlock), whiteLightedGlassBlock);
    
    yellowLightedGlassBlock = createBlock(new ModBlock(Material.GLASS, "yellow_lighted_glass_block", CreativeTabs.BUILDING_BLOCKS, 0.4F, 1.5F, 0, "pickaxe", 14/15F), event);
    ibYellowLightedGlassBlock = createItemBlock(new ItemBlock(yellowLightedGlassBlock), yellowLightedGlassBlock);
    
    //Granite
    granitePolishedDoor = createBlock(new ModBlockDoor(Material.ROCK, "granite_polished_door", 2.5F, 35F, 1, "pickaxe"), event);
    
    granitePolishedLamp = createBlock(new ModLamp(Material.ROCK, "granite_polished_lamp", CreativeTabs.DECORATIONS, 2F, 30F, 1, "pickaxe", 14/15F, 1.82D), event);
    ibGranitePolishedLamp = createItemBlock(new ItemBlock(granitePolishedLamp), granitePolishedLamp);
    
    granitePolishedLantern = createBlock(new ModLantern(Material.ROCK, "granite_polished_lantern", CreativeTabs.DECORATIONS, 2F, 18F, 1, "pickaxe", 13/15F, 5, 20, 0.5D), event);
    ibGranitePolishedLantern = createItemBlock(new ItemBlock(granitePolishedLantern), granitePolishedLantern);
    
    granitePolishedStairs = createBlock(new ModStairs(Blocks.STONE, "granite_polished_stairs", CreativeTabs.BUILDING_BLOCKS, 2.5F, 32F, 1, "pickaxe"), event);
    ibGranitePolishedStairs = createItemBlock(new ItemBlock(granitePolishedStairs), granitePolishedStairs);
    
    granitePolishedStairsAlt = createBlock(new ModStairs(Blocks.STONE, "granite_polished_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 1.7F, 26F, 1, "pickaxe"), event);
    ...
    terracottaStairs = createBlock(new ModStairs(Blocks.HARDENED_CLAY, "terracotta_stairs", CreativeTabs.BUILDING_BLOCKS, 2.2F, 21F, 0, "pickaxe"), event);
    ibTerracottaStairs = createItemBlock(new ItemBlock(terracottaStairs), terracottaStairs);
    
    terracottaStairsAlt = createBlock(new ModStairs(Blocks.HARDENED_CLAY, "terracotta_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 1.5F, 16F, 0, "pickaxe"), event);
    ...
    oakLightBox = createBlock(new ModBlock(Material.WOOD, "oak_light_box", CreativeTabs.DECORATIONS, 2F, 6F, 0, "axe", 12/15F, 5, 20), event);
    ibOakLightBox = createItemBlock(new ItemBlock(oakLightBox), oakLightBox);
    
    oakLantern = createBlock(new ModLantern(Material.WOOD, "oak_lantern", CreativeTabs.DECORATIONS, 1F, 4F, 0, "axe", 13/15F, 5, 20, 0.4D), event);
    ibOakLantern = createItemBlock(new ItemBlock(oakLantern), oakLantern);
    
    oakLamp = createBlock(new ModLamp(Material.WOOD, "oak_lamp", CreativeTabs.DECORATIONS, 1.2F, 4F, 0, "axe", 14/15F, 5, 20, 1.9D), event);
    ...
    polishedObsidianDoor = createBlock(new ModBlockDoor(Material.ROCK, "polished_obsidian_door", 45F, 5300F, 3, "pickaxe"), event);
    
    polishedObsidianStairs = createBlock(new ModStairs(Blocks.OBSIDIAN, "polished_obsidian_stairs", CreativeTabs.BUILDING_BLOCKS, 48F, 5500F, 3, "pickaxe"), event);
    ibPolishedObsidianStairs = createItemBlock(new ItemBlock(polishedObsidianStairs), polishedObsidianStairs);
    
    polishedObsidianStairsAlt = createBlock(new ModStairs(Blocks.OBSIDIAN, "polished_obsidian_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 40F, 5000F, 3, "pickaxe"), event);
    ...
    //Ore Blocks
    copperBlock = createBlock(new ModBlock(Material.IRON, "copper_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibCopperBlock = createItemBlock(new ItemBlock(copperBlock), copperBlock);
    
    tinBlock = createBlock(new ModBlock(Material.IRON, "tin_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibTinBlock = createItemBlock(new ItemBlock(tinBlock), tinBlock);
    
    bronzeBlock = createBlock(new ModBlock(Material.IRON, "bronze_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibBronzeBlock = createItemBlock(new ItemBlock(bronzeBlock), bronzeBlock);
    
    platinumBlock = createBlock(new ModBlock(Material.IRON, "platinum_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibPlatinumBlock = createItemBlock(new ItemBlock(platinumBlock), platinumBlock);
    
    silverBlock = createBlock(new ModBlock(Material.IRON, "silver_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibSilverBlock = createItemBlock(new ItemBlock(silverBlock), silverBlock);
    
    mithrilBlock = createBlock(new ModBlock(Material.IRON, "mithril_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibMithrilBlock = createItemBlock(new ItemBlock(mithrilBlock), mithrilBlock);
    
    titaniumBlock = createBlock(new ModBlock(Material.IRON, "titanium_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibTitaniumBlock = createItemBlock(new ItemBlock(titaniumBlock), titaniumBlock);
    
    celestialBronzeBlock = createBlock(new ModBlock(Material.IRON, "celestial_bronze_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe", 5/15F), event);
    ibCelestialBronzeBlock = createItemBlock(new ItemBlock(celestialBronzeBlock), celestialBronzeBlock);
    
    imperialGoldBlock = createBlock(new ModBlock(Material.IRON, "imperial_gold_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe", 7/15F), event);
    ibImperialGoldBlock = createItemBlock(new ItemBlock(imperialGoldBlock), imperialGoldBlock);
    
    steelBlock = createBlock(new ModBlock(Material.IRON, "steel_block", CreativeTabs.BUILDING_BLOCKS, 2F, 12F, 1, "pickaxe"), event);
    ibSteelBlock = createItemBlock(new ItemBlock(steelBlock), steelBlock);
    
  //Metal Bricks
    //Gold
    goldBrick = createBlock(new ModBlock(Material.ROCK, "gold_brick", CreativeTabs.BUILDING_BLOCKS, 50F, 5500F, 3, "pickaxe"), event);
    ibGoldBrick = createItemBlock(new ItemBlock(goldBrick), goldBrick);
    
    goldBrickStairs = createBlock(new ModStairs(Blocks.GOLD_BLOCK, "gold_brick_stairs", CreativeTabs.BUILDING_BLOCKS, 2.8F, 27F, 1, "pickaxe"), event);
    ibGoldBrickStairs = createItemBlock(new ItemBlock(goldBrickStairs), goldBrickStairs);
    
    goldBrickStairsAlt = createBlock(new ModStairs(Blocks.GOLD_BLOCK, "gold_brick_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 20F, 1, "pickaxe"), event);
    ibGoldBrickStairsAlt = createItemBlock(new ItemBlock(goldBrickStairsAlt), goldBrickStairsAlt);
    //Copper
    copperBrick = createBlock(new ModBlock(Material.ROCK, "copper_brick", CreativeTabs.BUILDING_BLOCKS, 50F, 5500F, 3, "pickaxe"), event);
    ibCopperBrick = createItemBlock(new ItemBlock(copperBrick), copperBrick);
    
    copperBrickStairs = createBlock(new ModStairs(copperBlock, "copper_brick_stairs", CreativeTabs.BUILDING_BLOCKS, 2.8F, 27F, 1, "pickaxe"), event);
    ibCopperBrickStairs = createItemBlock(new ItemBlock(copperBrickStairs), copperBrickStairs);
    
    copperBrickStairsAlt = createBlock(new ModStairs(copperBlock, "copper_brick_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 20F, 1, "pickaxe"), event);
    ibCopperBrickStairsAlt = createItemBlock(new ItemBlock(copperBrickStairsAlt), copperBrickStairsAlt);
    //Silver
    silverBrick = createBlock(new ModBlock(Material.ROCK, "silver_brick", CreativeTabs.BUILDING_BLOCKS, 50F, 5500F, 3, "pickaxe"), event);
    ibSilverBrick = createItemBlock(new ItemBlock(silverBrick), silverBrick);
    
    silverBrickStairs = createBlock(new ModStairs(silverBlock, "silver_brick_stairs", CreativeTabs.BUILDING_BLOCKS, 2.8F, 27F, 1, "pickaxe"), event);
    ibSilverBrickStairs = createItemBlock(new ItemBlock(silverBrickStairs), silverBrickStairs);
    
    silverBrickStairsAlt = createBlock(new ModStairs(silverBlock, "silver_brick_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 20F, 1, "pickaxe"), event);
    ibSilverBrickStairsAlt = createItemBlock(new ItemBlock(silverBrickStairsAlt), silverBrickStairsAlt);
    //Obsidian
    polishedObsidianBrick = createBlock(new ModBlock(Material.ROCK, "polished_obsidian_brick", CreativeTabs.BUILDING_BLOCKS, 50F, 5500F, 3, "pickaxe"), event);
    ibPolishedObsidianBrick = createItemBlock(new ItemBlock(polishedObsidianBrick), polishedObsidianBrick);
    
    polishedObsidianBrickStairs = createBlock(new ModStairs(polishedObsidianBlock, "polished_obsidian_brick_stairs", CreativeTabs.BUILDING_BLOCKS, 2.8F, 27F, 1, "pickaxe"), event);
    ibPolishedObsidianBrickStairs = createItemBlock(new ItemBlock(polishedObsidianBrickStairs), polishedObsidianBrickStairs);
    
    polishedObsidianBrickStairsAlt = createBlock(new ModStairs(polishedObsidianBlock, "polished_obsidian_brick_stairs_alt", CreativeTabs.BUILDING_BLOCKS, 2.0F, 20F, 1, "pickaxe"), event);
  ...
  public static void initItems(RegistryEvent.Register<Item> event) {
    ...
    iCelestialBronzePickaxe = createItem(new ModPickaxe("celestial_bronze_pickaxe", ModTool.ToolMaterial.CELESTIAL_BRONZE, 1.0F, -2.4F), event);
    iImperialGoldPickaxe = createItem(new ModPickaxe("imperial_gold_pickaxe", ModTool.ToolMaterial.IMPERIAL_GOLD, 1.0F, -2.4F), event);
    iObsidianPickaxe = createItem(new ModPickaxe("obsidian_pickaxe", ModTool.ToolMaterial.OBSIDIAN, 2.0F, -1.0F), event);
    ...
    iCelestialBronzeAxe = createItem(new ModAxe("celestial_bronze_axe", ModTool.ToolMaterial.CELESTIAL_BRONZE, 11F, -3.8F), event);
    iImperialGoldAxe = createItem(new ModAxe("imperial_gold_axe", ModTool.ToolMaterial.IMPERIAL_GOLD, 8.0F, -2.6F), event);
    ...
    iCelestialBronzeShovel = createItem(new ModSpade("celestial_bronze_shovel", ModTool.ToolMaterial.CELESTIAL_BRONZE), event);
    ...
    iCelestialBronzeSword = createItem(new ModSword("celestial_bronze_sword", ModTool.ToolMaterial.CELESTIAL_BRONZE), event);
