...
import com.DragonFerocity.expanded.world.biome.BiomeArctic;
...
public class ChunkGeneratorArctic implements IChunkGenerator {
  ...
  private int SeaLevel = 61;
  private double DepthNoiseScaleX = 100;
  private double DepthNoiseScaleZ = 50;
  private double DepthNoiseExponent = 0.15;
  private double MainNoiseScaleX = 120;
  private double MainNoiseScaleY = 120;
  private double MainNoiseScaleZ = 120;
  private float BiomeDepthOffset = 0;
  private float BiomeDepthWeight = 1;
  private float BiomeScaleWeight = 2;
  private float BiomeScaleOffset = 1;
  private float CoordinateScale = 200;
  private float HeightScale = 100;
  private double DepthBaseSize = 8.5;
  private float UpperLimitScale = 512;
  private float LowerLimitScale = 512;
  private float StretchY = 16;
  ...
  public ChunkGeneratorArctic(World worldIn, boolean mapFeaturesEnabledIn, long seed, BlockPos spawnPos)
  {
      {
      ...
      this.minLimitPerlinNoise = new NoiseGeneratorOctaves(this.rand, 24);
      this.maxLimitPerlinNoise = new NoiseGeneratorOctaves(this.rand, 24);
      this.mainPerlinNoise = new NoiseGeneratorOctaves(this.rand, 8);
      this.surfaceNoise = new NoiseGeneratorPerlin(this.rand, 2);
      this.scaleNoise = new NoiseGeneratorOctaves(this.rand, 7);
      this.depthNoise = new NoiseGeneratorOctaves(this.rand, 10);
      this.forestNoise = new NoiseGeneratorOctaves(this.rand, 16);
      ...
      this.oceanBlock = Blocks.PACKED_ICE.getDefaultState();
  ...
  public Chunk generateChunk(int x, int z)
  {
      ...
      {
          abyte[i] = (byte)BiomeArctic.getIdForBiome(this.biomesForGeneration[i]);
      }
  ...
  {
      this.depthRegion = this.depthNoise.generateNoiseOctaves(this.depthRegion, xOffset, zOffset, 5, 5, DepthNoiseScaleX, DepthNoiseScaleZ, DepthNoiseExponent);
      float f = CoordinateScale;
      float f1 = HeightScale;
      this.mainNoiseRegion = this.mainPerlinNoise.generateNoiseOctaves(this.mainNoiseRegion, xOffset, yOffset, zOffset, 5, 33, 5, (double)(f / MainNoiseScaleX), (double)(f1 / MainNoiseScaleY), (double)(f / MainNoiseScaleZ));
      ...
      for (int k = 0; k < 5; ++k)
      {
          for (int l = 0; l < 5; ++l)
          {
              ...
              for (int l1 = 0; l1 < 33; ++l1)
              {
                  ...
                  double d2 = this.minLimitRegion[i] / LowerLimitScale;
                  double d3 = this.maxLimitRegion[i] / UpperLimitScale;
  ...
  public void populate(int x, int z)
  {
      ...
      if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && !flag && this.rand.nextInt(15) == 0)
