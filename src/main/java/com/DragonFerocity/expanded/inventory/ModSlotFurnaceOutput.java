...
public class ModSlotFurnaceOutput extends SlotFurnaceOutput {
  private final EntityPlayer player;
  private int removeCount;
  
  public ModSlotFurnaceOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition){
  ...
  protected void onCrafting(ItemStack stack)
  {
      ...
      if (!this.player.world.isRemote)
      {
          ...
          float f = ModAlloyFurnaceRecipes.instance().getSmeltingExperience(stack);
