...
public class ModSlotCampfireOutput extends SlotFurnaceOutput {
  private final EntityPlayer player;
  private int removeCount;
  
  public ModSlotCampfireOutput(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition){
  ...
  protected void onCrafting(ItemStack stack)
  {
      ...
      if (!this.player.world.isRemote)
      {
          ...
          float f = ModCampfireRecipes.instance().getSmeltingExperience(stack);
